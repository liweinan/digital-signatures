...
public class SMIMETest {
    ...
    public static final String SERVER_URL = "http://localhost:8080/smime/smime";
    ...
    public void testEncryptedGet() throws Exception {
        WebTarget target = client.target(SERVER_URL + "/encrypted");
    ...
    public void testEncryptedAndSignedGet() throws Exception {
        WebTarget target = client.target(SERVER_URL + "/encrypted/signed");
