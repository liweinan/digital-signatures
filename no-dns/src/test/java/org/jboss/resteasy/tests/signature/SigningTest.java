...
public class SigningTest {
    ...
    public static final String SERVER_URL = "http://localhost:8080/content-signature-example";
    ...
    public void testVerification() throws Exception {
        ...
        WebTarget target = client.target(SERVER_URL + "/signed");
    ...
    public void testFailedVerification() throws Exception {
        ...
        WebTarget target = client.target(SERVER_URL + "/signed/bad-signature");
        Invocation.Builder request = target.request();
        request.property(Verifier.class.getName(), verifier);
        Response response = request.get();
    ...
    public void testExpiresMinutes() throws Exception {
        ...
        WebTarget target = client.target(SERVER_URL + "/signed/expires-minute");
        Invocation.Builder request = target.request();
        request.property(Verifier.class.getName(), verifier);
        Response response = request.get();
    ...
    public void testExpiresFail() throws Exception {
        ...
        WebTarget target = client.target(SERVER_URL + "/signed/expires-short");
        Invocation.Builder request = target.request();
        request.property(Verifier.class.getName(), verifier);
        Response response = request.get();
